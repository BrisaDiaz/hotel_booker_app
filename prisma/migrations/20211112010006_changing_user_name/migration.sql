...
CREATE TABLE "RoomModel" (
    ...
    "category" TEXT NOT NULL,
    "lowestPrice" DOUBLE PRECISION NOT NULL,
    "freeCancelation" BOOLEAN NOT NULL,
    "mainImage" TEXT NOT NULL,
    "description" TEXT,
    "maximunStay" INTEGER NOT NULL DEFAULT 0,
    "minimunStay" INTEGER NOT NULL DEFAULT 1,
    "maximunGuests" INTEGER NOT NULL,
...
CREATE TABLE "Features" (
    ...
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "hotelId" INTEGER NOT NULL,
    "cancelationFree" BOOLEAN NOT NULL DEFAULT false,
